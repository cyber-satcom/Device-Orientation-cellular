...
/* - more realistic bobble, css border-radius clipping issue though...
levelTool.h.css({
  'top': -(v-(v/2)-15) +'%',
  'left': h +'%'
});
...
levelTool.init = function(){
  ...
  // @todo: get this info from DOM instead of hardcoding
  // levelTool.size = 250; // the width or height of the tool area
  // levelTool.width = 80; // width of bubble
  // levelTool.height = 80; // height of bubble
  // levelTool.dx = levelTool.percentOf(levelTool.width, levelTool.size);
